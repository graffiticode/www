...
export default function BuildPage() {
  return (
    <Container className="py-16">
      <p className="text-sm font-medium text-brand-clay">For tool builders</p>
      <h1 className="mt-2 text-3xl font-semibold tracking-tight text-sand-50">Build a smart tool</h1>
      ...
      <div className="mt-10 space-y-6 text-sand-300">
        <div>
          <h2 className="font-semibold text-sand-50">Your domain expertise is the moat</h2>
        ...
        <div>
          <h2 className="font-semibold text-sand-50">One server, instantly reachable</h2>
          <p className="mt-2 max-w-2xl text-sand-400">
            Every tool you build deploys to the canonical MCP server at{' '}
            <code className="font-mono text-brand-clay">{MCP_ENDPOINT}</code> — reachable by any agent on the
      ...
      <div className="mt-10 rounded-xl border border-white/10 bg-zinc-900/50 p-6">
        <h2 className="text-lg font-semibold text-sand-50">Have an idea for a tool?</h2>
